...
from books.presentation.di.auth_di import get_auth_uc, get_current_user
...
@auth_router.post(path="/register", response_model=UserReturnSchema, status_code=status.HTTP_201_CREATED)
...
@auth_router.post(path="/login", response_model=TokenSchema, status_code=status.HTTP_200_OK)
...
@auth_router.get(path="/me", response_model=UserReturnSchema, status_code=status.HTTP_200_OK)
